package bernal.martin.myfeelings_bernalmartin
...
import bernal.martin.myfeelings_bernalmartin.utilities.CustomBarDrawable
import bernal.martin.myfeelings_bernalmartin.utilities.CustomCircleDrawable
import bernal.martin.myfeelings_bernalmartin.utilities.Emociones
import bernal.martin.myfeelings_bernalmartin.utilities.JSONFile
...
class MainActivity : AppCompatActivity() {
    ...
    fun iconoMayoria() {
        if(veryHappy>happy && veryHappy > neutral && veryHappy>sad&&veryHappy>verySad){
            ivIcon.setImageResource(R.drawable.ic_very_happy)
